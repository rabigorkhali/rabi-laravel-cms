                                            ...
                                            <label>
                                                <select name="role" class="form-select">
                                                    ...
                                                    @foreach($roles as $roleDatum)
                                                        <option value="{{$roleDatum->id}}"
                                                                @if (request('role') == $roleDatum->id) selected @endif>{{ucfirst($roleDatum->name)}}</option>
                                                    @endforeach
                            ...
                            <table class="datatables-users table dataTable no-footer dtr-column" id="DataTables_Table_0"
                                ...
                                @foreach ($thisDatas as $thisDatasKey => $thisDatasDatum)
                                    <tr>
                                        ...
                                        <td>{{ $thisDatasDatum->email }} </td>
                                        <td>{{ $thisDatasDatum->phone_number }}</td>
                                        <td>{{ ucfirst($thisDatasDatum->role->name) ?? 'N/A' }}</td>
